  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="border-white/30 bg-black/20 backdrop-blur-xl shadow-2xl">
        <CardHeader>
          <div className="flex items-center gap-3 mb-2">
            ...
            <CardTitle className="text-2xl text-white font-bold tracking-tight">Create Team</CardTitle>
          </div>
          ...
          <Form {...createForm}>
            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-white font-semibold">Team Name</FormLabel>
                    <FormControl>
      ...
      <div className="relative flex py-2 items-center">
        ...
        <span className="flex-shrink-0 mx-4 text-white/80 font-bold text-sm tracking-widest">OR</span>
        <div className="flex-grow border-t border-white/30"></div>
      </div>
      ...
      <Card className="border-white/30 bg-black/30 backdrop-blur-xl shadow-2xl">
        <CardHeader>
          <div className="flex items-center gap-3 mb-2">
            ...
            <CardTitle className="text-2xl text-white font-bold tracking-tight">Join Team</CardTitle>
          </div>
          <CardDescription className="text-white/80 text-base font-medium">
          ...
          <Form {...joinForm}>
            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-white font-semibold">Team ID</FormLabel>
                    <FormControl>
                      <Input 
